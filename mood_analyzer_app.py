...
def generate_response_and_analyze_mood(input_text):
    ...
    prompt_model = OpenAI(temperature=0.7, openai_api_key=openai_api_key, model='gpt-3.5-turbo-16k')
    mood_model = OpenAI(temperature=0.3, openai_api_key=openai_api_key, model='gpt-3.5-turbo-16k')
