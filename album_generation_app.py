...
def health_advisor(input_text, vector_store):
    ...
    image_url = DallEAPIWrapper(openai_api_key=openai_api_key).run("Generate an image following the privacy and policy guidelines, based on the following description: " + response)
